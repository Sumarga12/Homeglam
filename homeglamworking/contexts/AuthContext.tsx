...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const login = useCallback(async (email: string, pass: string, rememberMe: boolean): Promise<boolean> => {
    setLoading(true);
    try {
        ...
        console.log('localStorage:', localStorage.getItem('homeglam_user'));
        console.log('sessionStorage:', sessionStorage.getItem('homeglam_user'));
