    ...
    return (
        <AnimatedPage>
            ...
            <section className="bg-[#FFFBF5]">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight text-[#4E443C]">Luxurious care, effortless access.</h1>
                            <p className="mt-4 text-lg md:text-xl max-w-xl text-[#4E443C]/80">For your skin, hair, and everything in between.</p>
                        </motion.div>
                         <motion.div 
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                         ...
                         <motion.div 
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            <h2 className="text-3xl md:text-4xl font-serif text-[#4E443C]">Unleash your inner glow with beauty that comes home to you.</h2>
                            <Link to="/services">
                                <motion.button 
            ...
            <section className="py-16 sm:py-24 bg-[#FFFBF5]">
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.h2 
                        className="text-3xl md:text-4xl font-serif text-center text-[#4E443C] mb-12"
                    ...
                    >
                        ...
                        <div className="text-left">
                            <h3 className="text-xl font-semibold font-serif text-[#D97706]">{testimonials[0].name}</h3>
                            <p className="mt-2 text-lg text-[#4E443C]/90 leading-relaxed">"{testimonials[0].quote}"</p>
                        </div>
                    </motion.div>
                 </div>
            </section>
