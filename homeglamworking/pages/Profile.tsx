        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-2">
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <div className="p-4 border-t border-gray-200 bg-gray-50 text-[#4E443C]">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                        <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                            <img src={user.profilePhoto ? user.profilePhoto : `https://i.pravatar.cc/150?u=${user.email}`} alt={user.name} className="w-32 h-32 rounded-full object-cover border-4 border-[#D97706]/50" />
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <div className="mb-4">
                                    ...
                                    {photoPreview && (
                                        <div className="mt-2">
                                            ...
                                            <button onClick={handleUploadPhoto} disabled={uploading} className="mt-2 px-4 py-2 bg-[#D97706] text-white rounded-lg text-sm hover:bg-orange-700 transition">
                                ...
                                {isEditing ? (
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className="px-4 py-2 bg-green-500 text-white font-semibold rounded-lg text-sm hover:bg-green-600 transition flex items-center gap-1"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg text-sm hover:bg-gray-600 transition flex items-center gap-1"
                                            >
                                    ...
                                    <div>
                                        <h1 className="text-3xl font-serif font-bold text-[#4E443C]">{user.name}</h1>
                                        <p className="text-gray-600 mt-1">{user.email}</p>
                                        <div className="mt-4 flex flex-wrap gap-2 justify-center md:justify-start">
                                            <button 
                                                onClick={handleEditProfile}
                                                className="px-4 py-2 bg-[#D97706] text-white font-semibold rounded-lg text-sm hover:bg-orange-700 transition flex items-center gap-1"
                                            >
                                                <PencilIcon className="w-4 h-4" />
                                                Edit Profile
                                            </button>
                                            <Link to="/change-password">
                                                <button className="px-4 py-2 bg-gray-200 text-gray-800 font-semibold rounded-lg text-sm hover:bg-gray-300 transition">Change Password</button>
                                            </Link>
