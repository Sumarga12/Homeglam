...
const createPasswordResetEmail = (resetUrl, userName) => {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Password Reset - HomeGlam</title>
      <style>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>We received a request to reset your password for your HomeGlam account.</p>
          ...
          <p>Best regards,<br>The HomeGlam Team</p>
        </div>
        <div class="footer">
          <p>This email was sent to you because you requested a password reset for your HomeGlam account.</p>
          <p>© 2024 HomeGlam. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
...
const createWelcomeEmail = (userName) => {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Welcome to HomeGlam</title>
      <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Thank you for joining HomeGlam! We're excited to have you as part of our beauty community.</p>
          <p>With HomeGlam, you can:</p>
          <ul>
...
const sendEmail = async ({ to, subject, html, type = 'custom' }) => {
  try {
    ...
    const mailOptions = {
      from: `"HomeGlam" <${process.env.EMAIL_USER}>`,
      to,
      subject,
      html,
    };
...
const sendPasswordResetEmail = async (email, resetUrl, userName) => {
  ...
  return await sendEmail({
    to: email,
    subject: '🔐 Reset Your HomeGlam Password',
    html,
    type: 'password-reset'
  });
};
